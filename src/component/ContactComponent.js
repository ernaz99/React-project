...
import {Button, Breadcrumb,BreadcrumbItem, Row, Label, Col} from "reactstrap"
...
handleSubmit(values){
    ...
    return(
        ...
        <Row className="form-group">
            ...
            <Col md={10}>
                <Control.text model=".telnum" id="telnum" name="telnum" placeholder="Last Tel. Number" className="form-control" />
            </Col>
        </Row>
